...
- @ROOT_DETAIL@ `SDLC_PLUGIN_ROOT` is the package directory two levels above the loaded core skill directory (`skills/<name>/SKILL.md`). Do not infer it from the business working directory, scan other installed versions, or assume this variable is already exported.
