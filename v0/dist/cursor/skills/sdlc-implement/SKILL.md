...
2. **Check checklists status** (if FEATURE_DIR/checklists/ exists):
   ...
   - `checklists/requirements.md` is the built-in spec-quality checklist maintained by `/sdlc-specify` and `/sdlc-clarify`; custom checklists generated by `/sdlc-checklist` are reviewer-owned requirements-quality review artifacts
...
Note: This command assumes a complete task breakdown exists in tasks.md. If tasks are incomplete or missing, suggest running `/sdlc-tasks` first to regenerate the task list.
