...
- 修正维护升级示例，使跨版本 `prepare` 直接使用已导出的 `SDLC_RELEASE_TIME`，不再经未定义别名覆盖为空。
- 为跨版本 / 同版本 / 缺说明或缺时间场景补充真实 `prepare` 回归，断言候选记录与源码不变语义。

## 1.0.7-sdlc.1 — 2026-09-16

最后发版时间：2026-09-16 23:25:00 +08:00
