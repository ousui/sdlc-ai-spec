...
| --- | --- |
| Nine original command sources are kept byte-for-byte | Do not translate, optimize prompts, alter stages or inherit v1/v2 rules |
...
The next work package may consider INIT only after reviewing the engineering
result. This document is not an authorization to start it automatically.
