...
class RepositoryTests(unittest.TestCase):
    ...
    def test_metadata_and_attribution(self):
        ...
        self.assertEqual(m['version'],'1.0.5-sdlc.1')
        ...
        self.assertEqual(upstream['version'],'1.0.5')
        self.assertEqual(upstream['port_revision'],1)
        ...
        self.assertEqual(build['port_revision'],1)
