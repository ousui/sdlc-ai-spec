...
argument-hint: Describe the feature you want to define
---
...
```sh
python3 -I -B "${SDLC_PLUGIN_ROOT:?}/scripts/python/load_workflow.py" --host claude --skill sdlc-100-spec
```
